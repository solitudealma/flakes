...
in {
  programs.zed-editor = {
    ...
    userSettings = {
      ...
      features = { copilot = mkDefault false; };
      ...
      languages = {
        ...
        JavaScript = {
          formatter = {
            external = {
              command = "prettier";
              arguments =
                [ "--stdin-filepath" "{buffer_path}" "--tab-width" "2" ];
            };
          };
        ...
        Markdown = { enable_language_server = false; };
        Nix = {
          formatter = {
            external = { command = "${lib.getExe pkgs.nixfmt-classic}"; };
          };
      ...
      lsp = {
        eslint = {
          settings = { codeActionOnSave = { rules = [ "import/order" ]; }; };
        };
        nixd = {
    ...
    userKeymaps = [
      ...
      {
        context = "Workspace";
        bindings = { "shift shift" = "workspace::NewSearch"; };
      }
      {
        context = "Editor";
        bindings = {
      ...
      {
        context = "Terminal";
        bindings = { ctrl-t = "workspace::ToggleBottomDock"; };
      }
    ];
  };
